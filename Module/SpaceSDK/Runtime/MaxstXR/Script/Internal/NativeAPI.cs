...
namespace maxstAR
{
    internal class NativeAPI
    {
        ...
        public static void maxst_TrackerManager_updateFrame(bool isTexture) { }
        public static void maxst_TrackerManager_setSecretIdSecretKey(string secretId, string secretKey) {}
        public static void maxst_TrackerManager_setAccessToken(string token) {}
        public static int maxst_TrackerManager_getAccessToken(byte[] accessTokenString) { return 0; }
        ...
        public static void maxst_ARFrame_getVPSWorldTransform(ulong arFrame_cPtr, float[] transform) {}
        public static void maxst_ARFrame_getOriginalForVPSTransform(ulong arFrame_cPtr, float[] transform) {}
        public static void maxst_ARFrame_getOriginalTransform(ulong arFrame_cPtr, float[] transform) {}
        ...
        [DllImport(MaxstARLibName)]
        public static extern void maxst_CameraDevice_getFusionCameraIntrinsic(float[] intrinsic);
        ...
        [DllImport(MaxstARLibName)]
        public static extern void maxst_TrackerManager_setAccessToken(string token);
        ...
        [DllImport(MaxstARLibName)]
        public static extern void maxst_ARFrame_getVPSWorldTransform(ulong arFrame_cPtr, float[] transform);

        [DllImport(MaxstARLibName)]
        public static extern void maxst_ARFrame_getOriginalForVPSTransform(ulong arFrame_cPtr, float[] transform);

        [DllImport(MaxstARLibName)]
        public static extern void maxst_ARFrame_getOriginalTransform(ulong arFrame_cPtr, float[] transform);
